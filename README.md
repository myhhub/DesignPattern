[设计模式（Design pattern）完整教程](https://www.ljjyy.com/archives/2022/07/100684.html)，通过使用场景、关键代码、优缺点、实际案例等方面来讲解设计模式和设计原则，把容易混淆的设计模式进行区别对比，保证完全弄懂掌握23种设计模式和设计模式的七大原则，不仅有助于通过软考，更有助于提高开发水平。
